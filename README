...
I'll use Neovim and Lazy.Vim to easy up the path, but this might change.
...
## Install Lazy.Vim
Lazy.Vim comes with a set of plugins and configs that makes the use of Neovim more easy, just follow the instructions on https://www.lazyvim.org/ and we are good to go!
